...
import { totalDiscount, totalOriginalPrice } from "../../../../Helper";
    ...
    return (
        <div className="flex-column price-detail-section gap-1 card-shadow">
            ...
            <div className="flex-column gap-1 border-bottom price-value">
                <p className="flex-row align-center justify-between"><span>Price (1 item)</span> <span>&#8377;{totalOriginalPrice(cart)}</span></p>
            ...
            <div className="flex-row align-center justify-between border-bottom">
                ...
                <p>{totalOriginalPrice(cart) - totalDiscount(cart) + 899}</p>
            </div>
